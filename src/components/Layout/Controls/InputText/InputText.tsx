...
const InputText = React.forwardRef<HTMLInputElement, InputTextProps>(
  ({ variant, label, additionnalClassname, ...props }, ref) => {
    ...
    let classname = clsx(
      "border border-gray-300 dark:border-neutral-600 px-3 py-2 rounded-xl text-black dark:text-white bg-white dark:bg-neutral-700 focus:outline-none dark:focus:border-primary-500 focus:border-primary-500 duration-200 transition-colors ease-in-out",
      v,
